...
__all__ = ['SegmentationMetric1', 'batch_pix_accuracy', 'batch_intersection_union',
...
class SegmentationMetric1(object):
    ...
    def __init__(self, nclass):
        super(SegmentationMetric1, self).__init__()
        self.nclass = nclass
        self.reset()
    ...
    def get(self):
        ...
        #print(IoU)
        #print(mIoU)
        return pixAcc, mIoU,IoU0,IoU1,IoU2,IoU3,IoU4,IoU5,IoU6
